    ...
    <form action={action} className="nexus-panel rounded-2xl p-5 sm:p-6">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <h2 className="mt-2 text-base font-semibold text-slate-100">Registrar decisión técnica</h2>
        </div>
      </div>
    ...
    <form action={action} className="nexus-panel rounded-2xl p-5 sm:p-6">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <h2 className="mt-2 text-base font-semibold text-slate-100">Registrar error y solución</h2>
        </div>
      </div>
      <div className="mt-6 grid gap-4 md:grid-cols-2">
