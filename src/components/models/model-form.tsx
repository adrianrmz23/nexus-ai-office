...
export function ModelForm({ action, providers, technologies, model, error, mode }: Props) {
  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <section className="nexus-panel rounded-2xl p-5 sm:p-6">
        <div className="nexus-kicker">Capacidades</div><h2 className="mt-2 text-base font-semibold text-foreground">Compatibilidad operativa</h2>
      ...
      <section className="nexus-panel rounded-2xl p-5 sm:p-6">
        <div className="nexus-kicker">Evaluación interna</div><h2 className="mt-2 text-base font-semibold text-foreground">Puntuaciones de capacidad</h2><p className="mt-2 text-sm text-muted-foreground">Usa valores de 0 a 100 y deja vacío lo no validado.</p>
